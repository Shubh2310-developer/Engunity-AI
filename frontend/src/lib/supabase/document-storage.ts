 ...
 * Unified document management using Supabase Storage + Database
 */
...
/**
 * Upload and process a single document using Supabase
 */
export async function uploadDocument(file: File, userId: string): Promise<SupabaseDocument> {
  try {
    console.log('Starting Supabase upload for:', file.name, 'User:', userId);
